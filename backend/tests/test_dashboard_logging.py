...
def test_dashboard_logging():
    ...
    print(f"   2. Use arrow keys, help (?), and quit (q)")
    print(f"   3. Check logs/{current_date}/ for new log files")
    print(f"   4. Each run creates a new timestamped log file")
    
    print(f"\\n📋 Log Structure:")
    print(f"   logs/")
    print(f"   ├── dashboard-{current_date}/")
    print(f"   │   ├── dashboard-HH-MM-SS.log")
    print(f"   │   ├── dashboard-HH-MM-SS.log")
    print(f"   │   └── dashboard-HH-MM-SS.log")
    print(f"   └── dashboard-YYYY-MM-DD/")
    print(f"       └── dashboard-HH-MM-SS.log")
