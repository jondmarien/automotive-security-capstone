...
class TestBruteForceDetector:
    ...
    def sample_detected_signal(self, sample_signal_features):
        ...
        return DetectedSignal(
            ...
            timestamp=time.time(),
            classification_details={'pattern_match': 'FSK_burst', 'frequency_band': '433MHz'}
        )
    ...
    def test_suspicious_rate_detection(self, brute_force_detector, sample_detected_signal, signal_history):
        ...
        assert result['evidence']['attack_classification']['threat_level'] == 'suspicious'
    
    def test_moderate_threat_escalation(self, brute_force_detector, sample_detected_signal, signal_history):
    ...
    def test_high_threat_escalation(self, brute_force_detector, sample_detected_signal, signal_history):
    ...
    def test_critical_threat_escalation(self, brute_force_detector, sample_detected_signal, signal_history):
    ...
    def test_rapid_burst_detection(self, brute_force_detector, sample_detected_signal, signal_history):
        ...
        assert result['evidence']['attack_classification']['attack_type'] == 'rapid_burst'
    
    def test_sustained_attack_detection(self, brute_force_detector, sample_detected_signal, signal_history):
        ...
        for i in range(20):  # 20 signals over 5 minutes
            signal_data = {
                'signal_type': 'key_fob',
                'features': sample_detected_signal.features.to_dict(),
                'timestamp': base_time - (300 - i * 15)  # Every 15 seconds over 5 minutes
            }
            signal_history.add_signal(signal_data)
    ...
    def test_signal_consistency_analysis(self, brute_force_detector, sample_detected_signal, signal_history):
    ...
    def test_temporal_analysis_multiple_windows(self, brute_force_detector, sample_detected_signal, signal_history):
    ...
    def test_evidence_collection_completeness(self, brute_force_detector, sample_detected_signal, signal_history):
    ...
    def test_recommended_actions_by_threat_level(self, brute_force_detector):
        ...
        suspicious_actions = brute_force_detector._generate_recommended_actions('suspicious')
        assert 'Monitor signal source' in ' '.join(suspicious_actions)
        
        # Test moderate level actions
        moderate_actions = brute_force_detector._generate_recommended_actions('moderate')
        ...
        critical_actions = brute_force_detector._generate_recommended_actions('critical')
    ...
    def test_interval_consistency_calculation(self, brute_force_detector):
        ...
        consistency = brute_force_detector._calculate_interval_consistency(consistent_intervals)
        ...
        consistency = brute_force_detector._calculate_interval_consistency(inconsistent_intervals)
        assert 0.0 <= consistency < 1.0  # Lower consistency
    
    def test_signal_similarity_calculation(self, brute_force_detector, sample_detected_signal):
        ...
        similar_signal.features.burst_timing = sample_detected_signal.features.burst_timing
        
        similarity = brute_force_detector._calculate_signal_similarity(sample_detected_signal, similar_signal)
        assert similarity > 0.8  # High similarity
        
        # Create a different signal
        different_signal = Mock()
        different_signal.features = Mock()
        different_signal.features.frequency = sample_detected_signal.features.frequency * 1.1
        ...
        similarity = brute_force_detector._calculate_signal_similarity(sample_detected_signal, different_signal)
        assert similarity < 0.5  # Low similarity
    
    def test_performance_with_large_history(self, brute_force_detector, sample_detected_signal, signal_history):
    ...
    def test_different_signal_types_isolation(self, brute_force_detector, signal_history):
        ...
        tpms_signal = DetectedSignal(
            ...
            timestamp=time.time(),
            classification_details={'pattern_match': 'FSK_burst', 'frequency_band': '315MHz'}
        )
