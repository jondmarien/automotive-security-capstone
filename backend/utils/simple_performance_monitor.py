...
class SimplePerformanceMonitor:
        ...
        with self._lock:
            ...
            if processing_time_ms > 0:
                ...
                if self._processing_times:
                    self.metrics.average_processing_latency_ms = sum(
    ...
    def get_current_metrics(self) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            uptime_minutes = max(
                self.metrics.system_uptime_seconds / 60, 0.1
            ...
            return {
                ...
                "average_latency_ms": round(
                    self.metrics.average_processing_latency_ms, 1
                ),
                ...
                if self.metrics.rtl_sdr_connected
                else "Disconnected",
                "pico_w_status": "Connected"
                if self.metrics.pico_w_connected
                else "Disconnected",
    ...
    def get_detailed_report(self) -> Dict[str, Any]:
        ...
        return {
            "summary": metrics,
            "trends": {
                "latency_trend": list(self.latency_history)[
                    -10:
